...
def newpatient_Redir():
	...
	return render_template('/registration/patient_reg.html',regno=regno,disname = disname,cname=cname)
...
def ipdoldpatientviewdate():
	...
	if len(ipddata)>0:
		...
		return render_template('/ipdvisit/oldipdpatientsearch.html',msg="Sorry! No data Found")
...
def ViewByIssuedDate():
	...
	if len(getdata)>0:
		...
		return render_template('/medicine/MedicineOutwardSearch.html',ack1="Sorry! No data Found")
